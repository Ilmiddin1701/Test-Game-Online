...
class RegisterFragment : Fragment() {
    ...
    private fun addTestLevelData(userId: String) {
        //Tests 20
        val tests201 = TestLevelData(1, 0, 0, 20, 0, "0", true)
        val tests202 = TestLevelData(2, 0, 0, 20, 0, "0", false)
        val tests203 = TestLevelData(3, 0, 0, 20, 0, "0", false)
        val tests204 = TestLevelData(4, 0, 0, 20, 0, "0", false)
        val tests205 = TestLevelData(5, 0, 0, 20, 0, "0", false)
        val tests206 = TestLevelData(6, 0, 0, 20, 0, "0", false)
        val tests207 = TestLevelData(7, 0, 0, 20, 0, "0", false)
        val tests208 = TestLevelData(8, 0, 0, 20, 0, "0", false)
        val tests209 = TestLevelData(9, 0, 0, 20, 0, "0", false)
        val tests2010 = TestLevelData(10, 0, 0, 20, 0, "0", false)
        val tests2011 = TestLevelData(11, 0, 0, 20, 0, "0", false)
        val tests2012 = TestLevelData(12, 0, 0, 20, 0, "0", false)
        val tests2013 = TestLevelData(13, 0, 0, 20, 0, "0", false)
        val tests2014 = TestLevelData(14, 0, 0, 20, 0, "0", false)
        val tests2015 = TestLevelData(15, 0, 0, 20, 0, "0", false)
        val tests2016 = TestLevelData(16, 0, 0, 20, 0, "0", false)
        val tests2017 = TestLevelData(17, 0, 0, 20, 0, "0", false)
        val tests2018 = TestLevelData(18, 0, 0, 20, 0, "0", false)
        val tests2019 = TestLevelData(19, 0, 0, 20, 0, "0", false)
        val tests2020 = TestLevelData(20, 0, 0, 20, 0, "0", false)
        ...
        //Tests 30
        val tests301 = TestLevelData(1, 0, 0, 30, 0, "0", true)
        val tests302 = TestLevelData(2, 0, 0, 30, 0, "0", false)
        val tests303 = TestLevelData(3, 0, 0, 30, 0, "0", false)
        val tests304 = TestLevelData(4, 0, 0, 30, 0, "0", false)
        val tests305 = TestLevelData(5, 0, 0, 30, 0, "0", false)
        val tests306 = TestLevelData(6, 0, 0, 30, 0, "0", false)
        val tests307 = TestLevelData(7, 0, 0, 30, 0, "0", false)
        val tests308 = TestLevelData(8, 0, 0, 30, 0, "0", false)
        val tests309 = TestLevelData(9, 0, 0, 30, 0, "0", false)
        val tests3010 = TestLevelData(10, 0, 0, 30, 0, "0", false)
        val tests3011 = TestLevelData(11, 0, 0, 30, 0, "0", false)
        val tests3012 = TestLevelData(12, 0, 0, 30, 0, "0", false)
        val tests3013 = TestLevelData(13, 0, 0, 30, 0, "0", false)
        val tests3014 = TestLevelData(14, 0, 0, 30, 0, "0", false)
        val tests3015 = TestLevelData(15, 0, 0, 30, 0, "0", false)
        val tests3016 = TestLevelData(16, 0, 0, 30, 0, "0", false)
        val tests3017 = TestLevelData(17, 0, 0, 30, 0, "0", false)
        val tests3018 = TestLevelData(18, 0, 0, 30, 0, "0", false)
        val tests3019 = TestLevelData(19, 0, 0, 30, 0, "0", false)
        val tests3020 = TestLevelData(20, 0, 0, 30, 0, "0", false)
        ...
        //Tests 40
        val tests401 = TestLevelData(1, 0, 0, 40, 0, "0", true)
        val tests402 = TestLevelData(2, 0, 0, 40, 0, "0", false)
        val tests403 = TestLevelData(3, 0, 0, 40, 0, "0", false)
        val tests404 = TestLevelData(4, 0, 0, 40, 0, "0", false)
        val tests405 = TestLevelData(5, 0, 0, 40, 0, "0", false)
        val tests406 = TestLevelData(6, 0, 0, 40, 0, "0", false)
        val tests407 = TestLevelData(7, 0, 0, 40, 0, "0", false)
        val tests408 = TestLevelData(8, 0, 0, 40, 0, "0", false)
        val tests409 = TestLevelData(9, 0, 0, 40, 0, "0", false)
        val tests4010 = TestLevelData(10, 0, 0, 40, 0, "0", false)
        val tests4011 = TestLevelData(11, 0, 0, 40, 0, "0", false)
        val tests4012 = TestLevelData(12, 0, 0, 40, 0, "0", false)
        val tests4013 = TestLevelData(13, 0, 0, 40, 0, "0", false)
        val tests4014 = TestLevelData(14, 0, 0, 40, 0, "0", false)
        val tests4015 = TestLevelData(15, 0, 0, 40, 0, "0", false)
        val tests4016 = TestLevelData(16, 0, 0, 40, 0, "0", false)
        val tests4017 = TestLevelData(17, 0, 0, 40, 0, "0", false)
        val tests4018 = TestLevelData(18, 0, 0, 40, 0, "0", false)
        val tests4019 = TestLevelData(19, 0, 0, 40, 0, "0", false)
        val tests4020 = TestLevelData(20, 0, 0, 40, 0, "0", false)
        ...
        //Tests 50
        val tests501 = TestLevelData(1, 0, 0, 50, 0, "0", true)
        val tests502 = TestLevelData(2, 0, 0, 50, 0, "0", false)
        val tests503 = TestLevelData(3, 0, 0, 50, 0, "0", false)
        val tests504 = TestLevelData(4, 0, 0, 50, 0, "0", false)
        val tests505 = TestLevelData(5, 0, 0, 50, 0, "0", false)
        val tests506 = TestLevelData(6, 0, 0, 50, 0, "0", false)
        val tests507 = TestLevelData(7, 0, 0, 50, 0, "0", false)
        val tests508 = TestLevelData(8, 0, 0, 50, 0, "0", false)
        val tests509 = TestLevelData(9, 0, 0, 50, 0, "0", false)
        val tests5010 = TestLevelData(10, 0, 0, 50, 0, "0", false)
        val tests5011 = TestLevelData(11, 0, 0, 50, 0, "0", false)
        val tests5012 = TestLevelData(12, 0, 0, 50, 0, "0", false)
        val tests5013 = TestLevelData(13, 0, 0, 50, 0, "0", false)
        val tests5014 = TestLevelData(14, 0, 0, 50, 0, "0", false)
        val tests5015 = TestLevelData(15, 0, 0, 50, 0, "0", false)
        val tests5016 = TestLevelData(16, 0, 0, 50, 0, "0", false)
        val tests5017 = TestLevelData(17, 0, 0, 50, 0, "0", false)
        val tests5018 = TestLevelData(18, 0, 0, 50, 0, "0", false)
        val tests5019 = TestLevelData(19, 0, 0, 50, 0, "0", false)
        val tests5020 = TestLevelData(20, 0, 0, 60, 0, "0", false)
